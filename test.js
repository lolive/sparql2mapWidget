...
sparqlQueryJson(
myquery,
'http://192.168.56.101:9005/sparql/',
function(res){
 parseN3(res);
// var kmlAsText=(new XMLSerializer()).serializeToString(document.getElementById('kml'));
//var kmlObject = ge.parseKml(kmlAsText);
